...
class ModeloCompras{
	...
	static public function mdlIngresarCompras($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(codigo, id_proveedor, id_administrador, productos, impuesto, neto, total, metodo_pago) VALUES (:codigo, :id_proveedor, :id_administrador, :productos, :impuesto, :neto, :total, :metodo_pago)");
